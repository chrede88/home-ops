...
The two main components I need are a commandline interface and a text editor. I use [Ghostty](https://ghostty.org) and [Zed](https://zed.dev). In order to talk to Talos and Kubernetes I need to install the two binearies.
...
I also use kubecolor for a nice colored cli output.
...
With this I can use the `k` shorthand for kubectl and kubecolor will color the output nicely (based on the color theme deined in the conig file).
...
--install-image "factory.talos.dev/installer/30cf8203c9e4a8011a752c34a3ffb1b183cf65510c8ff98cc0c08fd16380e4b3:v1.11.5" \
...
The `install-image` URL is generated by the [Talos Image Factory](https://factory.talos.dev), based on which system extensions and extra kernel arguments you choose.
...
The install will hang because of the missing CNI. This is the point where I'll install Cilium using Helm. See the [Talos docs](hhttps://docs.siderolabs.com/kubernetes-guides/cni/deploying-cilium#method-1:-helm-install) for more info.
